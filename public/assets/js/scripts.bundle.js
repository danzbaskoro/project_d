...
var KTApp = function () {
    ...
    return {
        ...
        initBootstrapFullscreen: function () {
            KTUtil.on(document.body, '.fullscreenable[data-bs-toggle="fullscreen"]', "click", (function (e) {
                if (this.classList.contains("fullscreened") ? (this.classList.remove('card-fullscreen'), this.blur()) : this.classList.add('card-fullscreen'), this.hasAttribute("data-kt-toggle-text")) {
                    var t = this.getAttribute("data-kt-toggle-text"),
                        n = (n = this.querySelector('[data-kt-toggle-text-target="true"]')) || this;
                    this.setAttribute("data-kt-toggle-text", n.innerText), n.innerText = t
                }
...
var KTLayoutSearch = function () {
    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_header_search")) && (i = e.querySelector('[data-kt-search-element="wrapper"]'), e.querySelector('[data-kt-search-element="form"]'), t = e.querySelector('[data-kt-search-element="main"]'), n = e.querySelector('[data-kt-search-element="results"]'), r = e.querySelector('[data-kt-search-element="empty"]'), (m = new KTSearch(e)).on("kt.search.process", f), m.on("kt.search.clear", p))
        }
    }
}();
KTUtil.onDOMContentLoaded((function () {
